/* session-list.c generated by valac 0.20.1, the Vala compiler
...
static void __lambda18_ (SessionList* self, gchar** responses, int responses_length1);
static void ___lambda18__prompt_box_respond (PromptBox* _sender, gchar** response, int response_length1, gpointer self);
...
static void ___lambda18__prompt_box_respond (PromptBox* _sender, gchar** response, int response_length1, gpointer self) {
	__lambda18_ (self, response, response_length1);
}
...
static SessionPrompt* session_list_add_session_prompt (SessionList* self, const gchar* id) {
	...
	e = _tmp3_;
	g_signal_connect_object ((PromptBox*) e, "respond", (GCallback) ___lambda18__prompt_box_respond, self, 0);
